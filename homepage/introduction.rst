...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the piano piece *Jeux d’eau* has the following files:
